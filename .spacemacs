...
values."
  ...
  (setq-default
   ...
   ;; (default t)
   dotspacemacs-elpa-https nil   ;; Maximum allowed time in seconds to contact an ELPA repository.
...
(defun dotspacemacs/user-keys ()
  ...
  (spacemacs/set-leader-keys "w<" 'shrink-window)
  (spacemacs/set-leader-keys "w>" 'enlarge-window)
  ...
  (spacemacs/set-leader-keys "otm" 'text-mode)

  (spacemacs/declare-prefix "oe" "elisp-eval")
  (spacemacs/set-leader-keys "oel" 'eval-last-sexp)
  ...
  (spacemacs/set-leader-keys "ons" 'neotree-quick-look)
  (spacemacs/set-leader-keys "onh" 'neotree-hide)

  (spacemacs/declare-prefix "os" "just-search")
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (winum web-beautify livid-mode skewer-mode simple-httpd json-mode json-snatcher json-reformat js2-refactor js2-mode js-doc company-tern dash-functional tern coffee-mode multiple-cursors helm-git evil-magit magit-popup git-commit with-editor magit fuzzy git bundler robe paredit rvm ruby-tools ruby-test-mode rubocop rspec-mode rbenv rake minitest chruby inf-ruby 2048-game evil-nerd-commenter mmm-mode markdown-toc markdown-mode gh-md evil-commentary intero helm-company helm-c-yasnippet haskell-snippets company-statistics company-ghci company-ghc ghc company-cabal auto-yasnippet ac-ispell flycheck hlint-refactor hindent helm-hoogle haskell-mode company cmm-mode yasnippet auto-complete ws-butler window-numbering which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode package-build spacemacs-theme))))
(custom-set-faces
